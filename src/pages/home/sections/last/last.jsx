    ...
    <div className={styles.container}>
      ...
      <div className={styles.contents}>
        <p className={styles.description}>
          ...
          <br />
          <br />
          독학으로 혼자 공부하며 업무에 임할 때에는 홀로 배우고 문제를 해결하고
          주어진 과제를 어떻게 구현할 수 있을지에 집중했습니다.
          <br />
          <br />
          올해는
          <br />
          제게 주어진 JavaScript, React를 이용해 홈페이지를 구현함이 끝이 아니라
          <br />
          ...
          되는 팀원이 되고 싶습니다.
          <br />
          저는 팀과 함께 목표와 개발 지식을 나누고, 일에 집중하며 성과를 낼 수
          있는 회사를 원합니다.
          <br />
          <br />
        </p>
