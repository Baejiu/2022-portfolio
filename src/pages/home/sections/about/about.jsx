      ...
      <div className={styles.contents}>
        ...
        <div className={styles.content}>
          ...
          <p className={styles.description} {...useScrollFadeIn('up', 1, 0.5)}>
            ...
            프로그램을 개발할 때 다양한 선택을 해야 합니다. 쉬운 방향과 어려운
            방향, 혹은 기업을 위한 방향과 사용자를 위한 방향의 갈림길에서 더
            다양한 경우를 고려합니다. 기존 회사의 홈페이지가{' '}
            <b>
          ...
          <p className={styles.description} {...useScrollFadeIn('up', 1, 0.75)}>
            ...
            기존 홈페이지는 php로 개발되어 있었고, 처음 방문시 3000ms가량이
            걸렸습니다. 또한 다른페이지로 이동시 리로드되면서 번쩍거리는 현상이
            있었습니다. 리액트로 개발한 신규 회계프로그램은{' '}
            <b>
              처음 방문시 550ms이며 리액트의 특징을 이용해 페이지를 이동하면
              헤더는 고정된 채 하단만 리로드될 수 있도록 구현
            </b>
            되었습니다.
            <span className={styles.orangeColor}>
            ...
            <br />
            사수가 없는 상황으로 퇴근 후 유튜브 드림코딩과 책, 구글, 공홈을
            참고해 독학하며 업무에 임했습니다. 또한 부족한 전공지식을 채우고자
            IT시스템공학 과정의 야간대를 병행하고, 방학기간 중에는 JavaScript와
            자료구조 스터디에 참여하여 역량을 키우기 위해 노력하고 있습니다.
            <b>어제보다 오늘 더 성장하고 있습니다.</b>
          </p>
        </div>
      </div>
    </div>
